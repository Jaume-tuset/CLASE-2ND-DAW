(() => {
    ...
    //Act 4.  Fes que al fer click en p4 retorne la promesa de restaurar 
    //els gif i promeses anteriors. Tardarà 1 segon en restaurar
    let promesa4=document.querySelector("#p4");
    promesa4.addEventListener("click", (event) => {
